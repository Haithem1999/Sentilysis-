...
def main():
    ...
    #st.title('Sentilysis')
    #st.text('An app that scrapes tweets about any topic in real time') 

    html_temp = """
	 <div style="background-color:#1d3557;"><p style="color:white;font-size:40px;padding:9px">Real Time Tweet Sentiment Analysis</p></div>
	 """
    st.markdown(html_temp, unsafe_allow_html=True)
    # st.markdown('<style>body{background-color: #ade8f4;}</style>',unsafe_allow_html=True)
    st.subheader("Select a topic which you'd like to get the sentiment analysis on :")

    ################# Twitter API Connection #######################
    consumer_key = "aeJx0IErilOFWApFwHgFEJCWa"
    consumer_secret = "xq9RTDXRgZrlmUNRi07MtjoMRRXlMz56i6SRfoF14FUQ9LAzab"
    access_token = "2751736242-gBIFUle55fw3hOIjoSrSG0SdZL0T1y9Ve9AhwMN"
    access_token_secret = "9Ov7CE7ifOgawRWZj6ppEWzlV5bNV4njacBuOPYBId9IM"
    ...
    st.sidebar.info("This is a real time tweet sentiment analysis app which scrapes and extract tweets for the topic selected by the user. The extracted tweets will then be used to determine the sentiments of those tweets. \
                    The different visualizations will help you get a feel of the overall mood of the people on Twitter regarding the topic you select and allow you to pull more meaningful insights about the chosen topic.")
    #st.sidebar.text("Built with Streamlit")
    
    #st.sidebar.header("For Any Queries/Suggestions Please reach out at :")
    #st.sidebar.info("gasmihaithem2012@gmail.com")
